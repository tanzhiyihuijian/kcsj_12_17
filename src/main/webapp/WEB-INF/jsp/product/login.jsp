        ...
        <div class="row col-sm-offset-6">
            <div class="col-sm-6">
                ...
                <div class="row m0 contactForm">
                    ...
                    <button class="btn btn-primary btn-xs filled col-sm-12" id="submit">登录</button>
                    <div class="row m0 right">
                        <label><a href="register.html">立即注册</a>|<a href="forget-password.html">忘记密码</a></label>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#submit').on('click', function () {
            ...
            $.ajax({
                type: "POST",
                url : "/kcsj/furniture/login-submit",
                data : {
                    username: username,
                    password: password
                },
